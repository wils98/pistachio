...
EXPORT_PAGES = [
    ...
    {
        "filename": "rule5_h.html",
        "title": "Rule 5 Eligible (Hitters)",
        "columns": [
            "name",
            "org",
            "minor",
        ...
        "filter": lambda df: df["rule5_eligible"] & (df["wOBAP"] > 0.200),
        "page_len": 100,
    },
    {
        "filename": "rule5_p.html",
        "title": "Rule 5 Eligible (Pitchers)",
        "columns": [
            "name",
            "org",
            "minor",
        ...
        "filter": lambda df: df["rule5_eligible"] & (df["pwOBAP"] < 1.000),
        "page_len": 100,
    },
